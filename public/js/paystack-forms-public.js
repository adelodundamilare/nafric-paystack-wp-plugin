                                    ...
                                    $.post(
                                        ...
                                        function (newdata) {
                                            ...
                                            if (data.result == "success") {
                                                ...
                                                // if action is successfull, post a message to page.
                                                var showThankYou, showShortcode;
                                                showThankYou = document.getElementById('showThankYou');
                                                showShortcode = document.getElementById('showShortcode')

                                                showThankYou.style.display = 'block';
                                                showShortcode.style.display = 'none';

                                                // then continue what you're asked to do
                                                // this resets the paystack form....
