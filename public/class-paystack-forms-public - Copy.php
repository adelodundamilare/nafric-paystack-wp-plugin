		 ...
		 if ($obj->post_type == 'paystack_form') {
			...
			$planerrorcode = 'Input Correct Recurring Plan Code';
			 ...
			 echo '<div class="span12 unit">
				 ...
				 <div class="input">
					 <input readonly type="text" name="pf-fname" placeholder="First & Last Name" value="' . $fullname. '"
					 ';
			...
			echo' required>
			 ...
			 echo '<div class="span12 unit">
				 ...
				 <div class="input">
					 <input readonly type="email" name="pf-pemail" placeholder="Enter Email Address"  id="pf-email" value="' . $email. '"
					 ';
					 if($loggedin == 'yes'){
						 echo 'readonly ';
					 }
			...
			echo' required>
             ...
             echo '<div class="span12 unit"><label class="label">Amount</label><div class="input"><input readonly type="text" name="pf-plan" value="' . $nafricamount. '" /></div></div>';
			 echo '<div class="span12 unit">
