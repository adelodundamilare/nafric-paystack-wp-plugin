    ...
    if(!$pk){
     ...
     $obj = get_post($id);
		 if ($obj->post_type == 'paystack_form') {
            ...
            echo "<h1 id='pf-form".$id."'>Pay Online</h1>";
             ...
             echo '<input type="hidden" name="pf-transid" value="' . $nafrictransid. '" />';
             echo '<div class="span12 unit"><label class="label">Agent Name:</label><div class="input"><input readonly type="text" name="pf-uname" value="' . $uname. '" /></div></div>';
			 echo '<div class="span12 unit"><label class="label">Username</label><div class="input"><input readonly type="text" name="pf-fname" value="' . $fullname. '"></div></div>';
			 echo '<div class="span12 unit"><label class="label">Email</label><div class="input"><input readonly type="email" name="pf-pemail"  id="pf-email" value="' . $email. '"></div></div>';
             echo '<div class="span12 unit"><label class="label">Subscription Plan</label><div class="input"><input readonly type="text" name="pf-plan" value="' . $nafricplan. '" /></div></div>';
            //  echo '<div class="span12 unit"><label class="label">Amount ('.$currency;')</label><div class="input"><input readonly type="text" name="pf-plan" value="' . $nafricamount. '" /></div></div>';
			 echo '<div class="span12 unit">
				 <label class="label">Amount ('.$currency.')</label>
				 <div class="input">';
				if ($usevariableamount == 0) {
                    $amount = (float)preg_replace('/[^0-9\.]/ui','',$nafricamount);
					if ($minimum == 1) {
			...
			echo '<div class="span12 unit" style="clear:both;">
